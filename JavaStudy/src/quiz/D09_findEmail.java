...
public class D09_findEmail {
	...
	/*
		이메일을 판별할 수 있는 정규표현식을 작성하고 테스트해 보세요.
	*/
	public static void main(String[] args) {
		System.out.println(Pattern.matches("[a-z0-9_]+@?[a-z]+[.]+[a-z]+", "zeeta09gmail.com"));
		System.out.println(Pattern.matches("[a-z0-9_]+@?[a-z]+[.]+[a-z]+", "k_2da@naver.com"));
		System.out.println(Pattern.matches("[a-z0-9_]+@?[a-z]+[.]+([a-z]+|[a-z]+[.]?[a-z]+)", "zeeta09@duksung.ac.kr"));
	
	String text = "\r\n"
			+ "조선일보	가정/육아	박은주	zeeny@chosun.com\r\n"
	...
	Pattern findEmail = Pattern.compile("[a-z0-9_]+@?[a-z0-9]+[.]+([a-z]+[.]?[a-z]+|[a-z]+)");
	Matcher matcher = findEmail.matcher(text);
	int count = 0;
	while(matcher.find()) {
		count++;
		System.out.println("찾은 것 " + count + ":" + matcher.group() );
